...
function Home() {
  ...
  const postDepartmentData = () => {
    axios.post(baseUrl + "department", postData).then(() => {
      getDepartmentData();
    });
  };
  ...
  const postDesignationData = () => {
    axios
      .post(baseUrl + "designation", postData)
  ...
  const putEmployeesData = () => {
    axios.put(baseUrl + "employees/" + postData._id, postData);
  };
                ...
                <tbody>
                  {departmentList.map((i, n) => (
                    <tr>
                      ...
                      <td>
                        <i
                          onClick={() => dltDepartmentData(i._id)}
                          className="fa fa-trash"
                        ></i>
                        &nbsp;&nbsp;
                        <i className="fa fa-edit"></i>
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-8">
                      ...
                      >
                        ...
                        {departmentList
                          .filter((j) => j.section === postData.section)
                          .map((i) => (
                ...
                <tbody>
                  {designationList.map((i, n) => (
                    <tr>
                      ...
                      <td>
                        <i
                          onClick={() => dltDesignationData(i._id)}
                          className="fa fa-trash"
                        ></i>
                        &nbsp;&nbsp;
                        <i className="fa fa-edit"></i>
