...
function Home() {
const contractor=localStorage.getItem("contractorData")
const data =JSON.parse(contractor)

  const navigate = useNavigate();
  const [postData, setPostData]=useState(data)

  const putContractorData=(x)=>{
    axios.put(baseUrl +"contractor/"+x, postData).then(()=>navigate("/ContractorTable"))
  }
                      ...
                      >
                        ...
                        <div className="accordion-body">
                            ...
                            <div className="col-md-6">
                              <div className="row">
                                ...
                                <div className="col-sm-9">
                                  <input
                                  value={postData.contractorName}
                                  onChange={(e)=>setPostData({...postData,contractorName:e.target.value})}
                          ...
                          <div className="mt-4 text-center">
                            <button
                            onClick={()=>putContractorData(postData._id)}
                              type="submit"
                            ...
                            <button
                            onClick={()=>navigate("/ContractorTable")}
                              type="reset"
