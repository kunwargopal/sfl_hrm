  ...
  return (
      ...
      >
        ...
        <ul className="menu-inner py-1">
          ...
          <div
            className="abc"
            style={{ height:showDiv==="Master"? "23vh":"7vh",transition:"0.5s", overflow: "hidden", overflowY: "scroll" , width:"100%"}}
          >
        ...
        <li className="menu-item">
          <a onClick={() => navigate("/SupervisiorTable")} className="menu-link" style={{ cursor: "pointer" }}>
            <i class="menu-icon tf-icons bx bx-spreadsheet"></i>
            <div >Supervisor</div>
          </a>
        </li>
        <li className="menu-item">
          <a onClick={() => navigate("/ContractorTable")} className="menu-link" style={{ cursor: "pointer" }}>
            <i class="menu-icon tf-icons bx bx-spreadsheet"></i>
            <div >Contractor</div>
          </a>
        </li>
        <li className="menu-item">
          <a onClick={() => navigate("/LabourTable")} className="menu-link" style={{ cursor: "pointer" }}>
            <i class="menu-icon tf-icons bx bx-spreadsheet"></i>
            <div >Labour</div>
          </a>
        </li>
          ...
          <div
            className="abc"
            style={{ height:showDiv==="Attandence"? "23vh":"7vh",transition:"0.5s", overflow: "hidden", overflowY: "scroll" , width:"100%"}}
          >
               <li onClick={()=>setShowDiv(showDiv==="Attandence"?"":"Attandence")} className="menu-header small text-uppercase">
          <span className="menu-header-text">Attandence</span>
        </li>
        <li className="menu-item">
          <a onClick={() => navigate("/SupervisiorAtt")} className="menu-link" style={{ cursor: "pointer" }}>
            <i class="menu-icon tf-icons bx bx-spreadsheet"></i>
            <div >Supervisor Att.</div>
          </a>
        </li>
        <li className="menu-item">
          <a onClick={() => navigate("/ContractorAtt")} className="menu-link" style={{ cursor: "pointer" }}>
            <i class="menu-icon tf-icons bx bx-spreadsheet"></i>
            <div >Contractor Att.</div>
          </a>
        </li>
        <li className="menu-item">
          <a onClick={() => navigate("/LabourAtt")} className="menu-link" style={{ cursor: "pointer" }}>
            <i class="menu-icon tf-icons bx bx-spreadsheet"></i>
            <div >Labour Att.</div>
          </a>
        </li>
          ...
          <div
            className="abc"
            style={{ height:showDiv==="AttandenceDetails"? "23vh":"7vh",transition:"0.5s", overflow: "hidden", overflowY: "scroll" , width:"100%"}}
          >
               <li onClick={()=>setShowDiv(showDiv==="AttandenceDetails"?"":"AttandenceDetails")} className="menu-header small text-uppercase">
          <span className="menu-header-text">Attandence Details</span>
        </li>
        <li className="menu-item">
          <a onClick={() => navigate("/SupervisorAttDetails")} className="menu-link" style={{ cursor: "pointer" }}>
            <i class="menu-icon tf-icons bx bx-spreadsheet"></i>
            <div >Supervisor Att. Details</div>
          </a>
        </li>
        <li className="menu-item">
          <a onClick={() => navigate("/ContractorAttDetails")} className="menu-link" style={{ cursor: "pointer" }}>
            <i class="menu-icon tf-icons bx bx-spreadsheet"></i>
            <div >Contractor Att. Details</div>
          </a>
        </li>
       
        <li className="menu-item">
          <a onClick={() => navigate("/LabourAttDetails")} className="menu-link" style={{ cursor: "pointer" }}>
            <i class="menu-icon tf-icons bx bx-spreadsheet"></i>
            <div >Labour Att. Details</div>
          </a>
        </li>
          ...
          <div
            className="abc"
            style={{ height:showDiv==="Salary"? "23vh":"7vh",transition:"0.5s", overflow: "hidden", overflowY: "scroll" , width:"100%"}}
          >
               <li onClick={()=>setShowDiv(showDiv==="Salary"?"":"Salary")} className="menu-header small text-uppercase">
          <span className="menu-header-text">Salary Details</span>
        </li>
        <li className="menu-item">
          <a onClick={() => navigate("/SuperSalary")} className="menu-link" style={{ cursor: "pointer" }}>
            <i class="menu-icon tf-icons bx bx-spreadsheet"></i>
            <div >Supervisor Salary Details</div>
          </a>
        </li>
        <li className="menu-item">
          <a onClick={() => navigate("/ContractorSalary")} className="menu-link" style={{ cursor: "pointer" }}>
            <i class="menu-icon tf-icons bx bx-spreadsheet"></i>
            <div >Contractor Salary Details</div>
          </a>
        </li>
        <li className="menu-item">
          <a onClick={() => navigate("/LabourSalary")} className="menu-link" style={{ cursor: "pointer" }}>
            <i class="menu-icon tf-icons bx bx-spreadsheet"></i>
            <div >Labour Salary Details</div>
          </a>
        </li>
